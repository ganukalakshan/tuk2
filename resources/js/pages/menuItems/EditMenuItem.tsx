...
export default function EditMenuItem({ isOpen, menuItem, onClose, onSuccess }: EditMenuItemProps) {
    ...
    useEffect(() => {
        if (menuItem && isOpen) {
            setFormData({
                ...
                department_id: menuItem.department_id ? menuItem.department_id.toString() : '',
                sale_type: menuItem.sale_type,
                prep_type: menuItem.prep_type,
                price: menuItem.price.toString(),
                cost: menuItem.cost.toString(),
                is_active: menuItem.is_active,
                display_order: menuItem.display_order.toString(),
                image: null,
            });
        }
    }, [menuItem, isOpen]);
            ...
            <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-slate-800">Edit Menu Item</h3>
                    </div>
                    <button
                        onClick={handleClose}
                            ...
                            <div className="space-y-2">
                                {menuItem?.image && (
                                    <div className="mb-2">
                                        ...
                                        <img
                                            src={`/storage/menu-items/${menuItem.image}`}
                                            alt="Current"

...
export default function DeleteMenuItem({ menuItem, onSuccess, onCancel }: DeleteMenuItemProps) {
            ...
            <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl transform transition-all">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-slate-800">Delete Menu Item</h3>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="bg-slate-50 rounded-lg p-4 mb-4">
                                ...
                                <p className="text-sm text-slate-500">Code: {menuItem.code}</p>
                                <p className="text-sm text-slate-500">Price: {menuItem.price} LKR</p>
                                {menuItem.category && (
                                    <p className="text-sm text-slate-500">Category: {menuItem.category.name}</p>
                                )}
                            </div>

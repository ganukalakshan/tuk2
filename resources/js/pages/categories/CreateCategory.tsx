...
export default function CreateCategory({ isOpen, onClose, onSuccess, categories = [] }: CreateCategoryProps) {
            ...
            <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl transform transition-all">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1.5">Select a parent category to create a subcategory</p>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Toggle to make the category usable</p>
                        </div>
                        <button
                            type="button"

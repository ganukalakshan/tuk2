...
interface EditMeasurementUnitProps {
    isOpen: boolean;
...
export default function EditMeasurementUnit({ isOpen, unit, onClose, onSuccess }: EditMeasurementUnitProps) {
    const [formData, setFormData] = useState<MeasurementUnitFormData>({
        unit_name: '',
        unit_symbol: '',
        is_base: false,
        conversion_to_base: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`/api/measurement-units/${unit.id}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
